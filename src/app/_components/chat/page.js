    ...
    const ChatRoom = ({ roomId, userName }) => {
        ...
        // Add this effect to handle page reload prevention
        useEffect(() => {
            // Set unsaved changes flag when there are messages in the chat
            ...
            const handleBeforeUnload = (e) => {
                if (unsavedChanges) {
                    // Standard way to show confirmation dialog on page reload/close
        ...
        const handleExitGroup = () => {
            // Set unsaved changes to false before exit to prevent the prompt
        ...
        return (
            ...
            <div 
                ref={scroll} 
                className="flex flex-col w-full mx-auto overflow-y-auto rounded-xl p-2 md:p-4 scrollbar-thin scrollbar-thumb-purple-400 h-[calc(100vh-240px)] sm:h-[calc(100vh-220px)]"
            >
                {chat.map((msg, index) => (
